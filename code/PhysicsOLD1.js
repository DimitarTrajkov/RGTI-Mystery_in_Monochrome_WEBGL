...
//         // remove the transformation from object a-camera
...
// __________________________________________________________________________
// __________________________________________________________________________
// WORKING REMOVAL OF ITEMS WHEN NEAR AND keyP
// __________________________________________________________________________
// __________________________________________________________________________
import { vec3, mat4 } from "glm";
import { getGlobalModelMatrix } from "engine/core/SceneUtils.js";
...
export class Physics {
  constructor(scene, items_to_pick_up, colorArray, lightComponent) {
    ...
    // document.getElementById("correct-music").pause();
    // document.getElementById("ticking-music").pause();
  ...
  //     // Start ticking music
  //     if (this.tickingMusic) {
  //       // this.tickingMusic.muted = true; // Mute it initially
  //       this.tickingMusic.volume = 0.15;
  //       console.log(this.tickingMusic.volume);
  //       console.log(this.tickingMusic.muted);
  //       this.tickingMusic
  //         .play()
  //         .then(() => {
  //           this.tickingMusic.playbackRate = 1; // Set playback rate after play starts
  //         })
  //         .catch((error) =>
  //           console.log("Ticking music playback failed:", error)
  //         );
  //     }
  ...
  updateMusicSpeed() {
    ...
    this.tickingMusic.volume =
      0.15 + Math.max(((30 - this.timeLeft) / 30) * 0.75, 0);
