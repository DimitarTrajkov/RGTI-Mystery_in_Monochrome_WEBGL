...
await loader.load("https://sivanovska.github.io/WebGL-assets/scene55.gltf");
...
const pickable_items = [
  "all_purpose_cleaner","battery","bleach_bottle","blue cleaner",
  "bonbons","lil duck","medkit","molotov","open book",
...
const lift_up = new LinearAnimator(Lift, {dx: 0,dy: 3.4,dz: 0,duration: 2.5});
const lift_down = new LinearAnimator(Lift, {dx: 0,dy: -3.4,dz: 0,duration: 2.5});
